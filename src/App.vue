<template>
    <div id="app">
        ...
        <div id="users">
            ...
            <label>
                <input class="form-control align-middle d-inline-block" type="text" v-model="filter.name"
            ...
            <div class="Users">
                <table id="tbl-users" class="table table-hover">
                    ...
                    <tbody>
                    <Users @click="showUserModal(u)" v-for="(u, index) in usersSorted" :key="index"
                           :value="u" />
        ...
        <UserModal :user="selectedUser" v-show="isModalVisible" @close="closeUserModal"/>
    </div>
</template>
